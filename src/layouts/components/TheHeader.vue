...
const departmentMenu = [
  ...
  // 👉 You can continue the rest (Computers, Babies & Moms, etc.) in the same format
];
...
const menuItems = ref([
  {
    ...
    link: "index.html",
    // children: [
    //   { title: "Martfury v01 - Marketplace", link: "http://martfury.magebig.com/stores/store/switch/?___from_store=ar&___store=en" },
    //   { title: "Martfury v02 - Electronic", link: "stores/store/switch/index67f1.html?___from_store=ar2&___store=en2" },
    //   { title: "Martfury v03 - Organic", link: "http://martfury03.magebig.com/stores/store/switch/?___from_store=ar3&___store=en3" },
    //   { title: "Martfury v04 - Furniture", link: "http://martfury04.magebig.com/stores/store/switch/?___from_store=ar4&___store=en4" },
    //   { title: "Martfury v05 - Market", link: "http://martfury05.magebig.com/stores/store/switch/?___from_store=ar5&___store=en5" },
    //   { title: "Martfury v05 - FullWidth", link: "http://martfury05.magebig.com/stores/store/switch/?___from_store=ar5&___store=es" }
    // ]
  },
  {
    title: "Category",
    link: "#",
    children: [
      { title: "Category View - Grid", link: "consumer-electric40bd.html?product_list_mode=grid" },
      { title: "Category View - List", link: "consumer-electric0744.html?product_list_mode=list" }
    ]
  },
  {
    title: "Product",
    link: "#",
    children: [
      { title: "Simple Product", link: "dbpower-t20-1500-lumens-lcd-projector.html" },
      { title: "Configurable Product", link: "sleeve-linen-blend-caro-pane-shirt.html" },
      { title: "Group Product", link: "men-sports-running-swim-group.html" },
      { title: "Bundle Product", link: "samsung-4k-ultra-hd-smart-led-tv.html" },
      { title: "Tier Product", link: "mvmth-classical-leather-watch-in-black.html" },
      { title: "Downloadable Product", link: "grand-slam-indoor-of-show-jumping-novel.html" }
    ]
  },
  {
    title: "Blog",
    link: "blog.html",
    children: [
      { title: "Business", link: "blog/category/bussiness/index.html" },
      { title: "Technology", link: "blog/category/technology/index.html" },
      { title: "Fashion", link: "blog/category/fashion/index.html" }
    ]
  },
  {
    title: "Contact",
...
<template>
  <header class="page-header">
      ...
      <div class="container">
        <div class="row align-items-center header-top-row">
          <div class="d-none d-md-block col-sm-3 col-lg-5">
            <div class="welcome">Welcome to Magneto Online Store</div>
          </div>
                    ...
                    <ul class="dropdown switcher-dropdown">
                      <li class="view-du switcher-option"> <a href="#"
                          ...
                          <span class="lang-flag du"> <img loading="lazy" class="img-fluid" alt="du" width="18"
                              height="12" src="/media/webps/png/media/wysiwyg/magebig/languages/du.webp" data-webp="1">
                          </span> <span class="lang-name">Dutch</span> </a></li>
                      <li class="view-ar2 switcher-option"> <a href="#"
                          ...
                          <span class="lang-flag ar2"> <img loading="lazy" class="img-fluid" alt="ar2" width="18"
                              height="12" src="/media/webps/png/media/wysiwyg/magebig/languages/ar2.webp" data-webp="1">
                          </span> <span class="lang-name">Arabic</span> </a></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-navigation vertical-menu d-none d-md-block">
                ...
                <div class="navigation" data-action="navigation">
                  <ul class="smartmenu magebig-nav">
                    <li v-for="(menu, i) in departmentMenu" :key="i" class="level0"
                      ...
                      <a :href="menu.link" class="level-top">
                        ...
                        <span>
                          {{ menu.title }}
                          <span v-if="menu.label" class="cat-label" :class="`cat-label-${menu.label}`">{{ menu.label
                            }}</span>
                        </span>
                      </a>
                      ...
                      <div v-if="menu.children" class="submenu show-sub">
                        <div class="show-sub-content">
                          <div class="mbmenu-block mbmenu-block-center menu-items col12-12 itemgrid itemgrid-2col">
                            <ul class="level0">
                              <li v-for="(child, j) in menu.children" :key="j" class="level1 groups item parent">
                                ...
                                <div v-if="child.children" class="groups-wrapper">
                                  <div class="show-sub-content">
                                    <ul class="level1">
                                      <li v-for="(sub, k) in child.children" :key="k" class="level2 nav-item">
                          ...
                          <div v-if="menu.staticBlock" class="mbmenu-block mbmenu-block-bottom grid-full std">
                            <div class="static-bottom-menu">
                              ...
                              <div class="img-outside">
                                <img class="img-fluid" :src="menu.staticBlock.image" alt="" width="458" height="298"
                                  loading="lazy" />
                              </div>
                            </div>
                          </div>
            ...
            <div class="col-9 col-md-9 col-lg-6 d-none d-md-block">
              <div class="horizontal-menu-wrap">
                <div class="horizontal-menu">
                  <ul class="smartmenu magebig-nav">
    <li v-for="(item, i) in menuItems" :key="i" class="level0 level-top mega_ parent">
      <a class="level-top" :href="item.link">
        <span>{{ item.title }}</span>
      </a>
      <i v-if="item.children" class="mbi mbi-ios-arrow-down">&nbsp;</i>

      <!-- Submenu -->
      <div v-if="item.children" class="simple-dropdown submenu show-sub" style="width: 270px; height: auto;">
        <div class="mbmenu-block mbmenu-block-center menu-items col12-12 itemgrid itemgrid-4col">
          <ul class="level0">
            <li v-for="(child, j) in item.children" :key="j" class="level1 item level-top mega_">
              <a class="level-top" :href="child.link">
    ...
    <div class="d-block d-md-none col-btn-actions">
      <div class="header-content-action row no-gutters">
        <div class="btn-nav-mobile col"> <button type="button" class="btn-nav mb-toggle-switch mb-toggle-switch__htx"
